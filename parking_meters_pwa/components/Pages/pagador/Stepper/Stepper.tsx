...
export const Stepper = ({ startTime, endTime }: CustomCardProps) => {
  return (
    ...
    // <div className="flex justify-center items-center my-8 p-0 ">
    //   <ol className="items-center space-y-4 xs:flex xs:space-x-8 xs:space-y-0 md:flex md:space-x-8 md:space-y-0 rtl:space-x-reverse">
    //     <li className="flex items-center justify-center text-blue-600 dark:text-blue-500 space-x-2.5 rtl:space-x-reverse">
    //       <span className="flex items-center justify-center w-8 h-8 border border-blue-600 rounded-full shrink-0 dark:border-blue-500">
    //         <FaRegCalendarAlt/>
    //       </span>
    //       <span>
